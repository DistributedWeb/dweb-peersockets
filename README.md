...
Peersockets is a lightweight wrapper around [`@dwebstore/networker`](https://github.com/andrewosh/dwebstore-networker) that lets you exchange topic-tagged messages with peers over [`ddatabase-protocol`](https://github.com/distributedweb/ddatabase-protocol) streams.
...
```
### Example
This example assumes you already have Networker ([`@dwebstore/networker`](https://github.com/andrewosh/dwebstore-swarm-networking)) instance.
```
...
* `networker` is an instance of [`@dwebstore/networker`](https://github.com/andrewosh/dwebstore-networker)).
